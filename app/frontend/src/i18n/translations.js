export const translations = {
  en: {
    common: {
      ...
      startOfView: "Start of this view",
      highestPriceAround: "Highest price around",
      lowestAround: "Lowest around",
      highestAround: "Highest around",
      extendsNextMorning: "Extends into the next morning",
      finalPrice: "Final price",
      ourForecast: "Our forecast",
      aesoForecast: "AESO forecast",
      ourPrice: "Our price",
      aesoPrice: "AESO",
      action: "Action",
      level: "Level",
      ...
      overallAverageDifference: "Overall average difference",
      ours: "Ours",
      hideExplanation: "Hide explanation",
      howToRead: "How to read this page",
      notPublished: "Not published yet",
      loading: "Loading forecasts…",
      noDataForDate: "No data available for",
      goBackToday: "Go back to today",
      cannotConnect: "Cannot connect to the forecast server",
      serviceUnavailable: "The forecast service is temporarily unavailable.",
      somethingWentWrong:
        "Something went wrong. Please refresh the page and try again.",
      noFinalPricesYet:
        "No final market prices are available yet for this date.",
      checkAgainLater:
        "Please check again later once the final market prices have been published.",
      now: "Now",
      best: "Best",
      highest: "Highest",
    },
    ...
    tabs: {
      chart: "Daily chart",
      table: "Hourly table",
      compare: "Forecast check",
    },

    hero: {
      forecastFor: "Forecast for",
      thisViewStartsAt: "This view starts at",
      bestTimeToUse: "Best time to use electricity",
      averagePriceToday: "Average price today",
      forecastResultForDate: "Forecast result for this date",
      cheapestHourToday: "Cheapest hour today",
      mostExpensiveHourToday: "Most expensive hour today",
      thisLooksCheaper:
        "This looks like a cheaper part of the day. A flexible 10 kWh use could save about",
      ifMovedToBestHour: "if moved to the best hour.",
      simpleView:
        "This gives you a simple view of whether this hour looks cheaper or more expensive than the rest of the day.",
      bestWindowHelper:
        "This looks like the best 3-hour window today for laundry, dishwashing, cooking, or EV charging.",
      notEnoughDataWindow:
    ...
    trust: {
      ...
      title: "How reliable this forecast has been overall",
      summaryPrefix:
        "This summary is based on past results across many hours, not only",
      oursBetter:
        "So far, our forecast has generally been closer to the final market price than the AESO forecast.",
      aesoBetter:
        "So far, the AESO forecast has generally been closer to the final market price than our forecast.",
      noBenchmarks: "Overall benchmark data is not available yet.",
      avgDiffFromFinal: "Average difference from the final price",
    },

    chart: {
      eyebrow: "Daily guidance",
      title: "Electricity price outlook for",
      subtitle:
        "Use this chart to quickly spot the cheaper hours and the more expensive peaks in this view.",
    },
    ...
    table: {
      ...
      normalUse: "Normal use is fine",
      waitIfPossible: "Wait if possible",
      avoidHeavyUse: "Avoid heavy use",
    },

    compare: {
      eyebrow: "Forecast check",
      title: "How the forecasts performed on",
      subtitle:
        "This section compares our forecast with the AESO forecast only for the hours where the final market price is already known.",
      oursCloser:
        "For the completed hours on this date, our forecast was closer overall.",
      aesoCloser:
        "For the completed hours on this date, the AESO forecast was closer overall.",
      ourAverageDifference: "Our average difference",
      aesoAverageDifference: "AESO average difference",
      overallResult: "Overall result",
      ourCloser: "Our forecast was closer",
      aesoCloserShort: "AESO was closer",
      offBy: "Off by",
    },

    explainer: {
      whatMeans: "What this price means",
      whatMeansBody:
        "This is the wholesale electricity price in Alberta for a given hour. It helps show when electricity conditions look easier or more expensive.",
      whyChanges: "Why the price changes",
      whyChangesBody:
        "The price can move quickly when demand rises, supply gets tighter, or market conditions become stressed.",
      howHelps: "How this page helps",
      howHelpsBody:
        "This page helps you spot better hours for flexible household use, such as laundry, dishwashing, cooking, or EV charging.",
    },
  },
  ...
  fr: {
    ...
    tabs: {
      chart: "Graphique du jour",
      table: "Tableau horaire",
      compare: "Vérification des prévisions",
    },
    ...
    trust: {
      eyebrow: "Vérification de fiabilité",
      title: "Fiabilité globale de la prévision",
      summaryPrefix:
    ...
    table: {
      ...
      normalUse: "Utilisation normale acceptable",
      waitIfPossible: "Attendre si possible",
      avoidHeavyUse: "Éviter les gros usages",
    },
